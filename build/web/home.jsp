...
<html>
    <head>
        ...
        <script type="text/javascript">
            function openFormProdutividade() {
                document.getElementById("controle_produtividade").style.display = "block";
            }
            function closeFormProdutividade() {
                document.getElementById("controle_produtividade").style.display = "none";
            }
            function openFormFinanceiro() {
                document.getElementById("controle_financeiro").style.display = "block";
            }
            function closeFormFinanceiro() {
                document.getElementById("controle_financeiro").style.display = "none";
            }
    ...
    <body>    
        ...
        <form action="ControllerContestation" method="post">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav mr-auto form-inline"> 
                        <li class="nav-item active">
                            ...
                            <button class="btn btn-outline-info" name="btn_prod" type="button" onclick="openFormProdutividade()"><svg class="svg-icon" viewBox="0 0 20 20">
                            ...
                            <button class="btn btn-outline-info" name="btn_exporterro" type="button"><svg class="svg-icon" viewBox="0 0 20 20">
                                <path fill="none" d="M3.015,4.779h1.164V3.615H3.015V4.779z M18.73,1.869H1.269c-0.322,0-0.582,0.26-0.582,0.582v15.133
                                      c0,0.322,0.26,0.582,0.582,0.582H18.73c0.321,0,0.582-0.26,0.582-0.582V2.451C19.312,2.129,19.052,1.869,18.73,1.869z
                                      M18.148,16.42c0,0.322-0.261,0.582-0.582,0.582H2.433c-0.322,0-0.582-0.26-0.582-0.582V6.525h16.297V16.42z M18.148,5.361H1.851
                                      V3.615c0-0.322,0.26-0.582,0.582-0.582h15.133c0.321,0,0.582,0.26,0.582,0.582V5.361z M7.671,4.779h1.165V3.615H7.671V4.779z
            ...
            <main role="main" class="container">
                ...
                <div class="row ex1" id="controle_produtividade">
                    Data Início:
                    <input type="date" name="txt_prodini" value="">

                    Data Fim:
                    <input type="date" name="txt_prodfim" value="">

                    <button type="button" onclick="closeFormProdutividade()">Fechar</button>
                    <button type="submit" name="btn_produtivade">Enviar</button>
                    <br/><br/>
                </div> 
                <div class="jumbotron">
                    <h1>Bem-vindo(a)! <%=user.getNome()%></h1>
                    <input type="hidden" name="txt_user" value="<%=user.getLogin()%>"/>
                </div>
                <div>
                    <label for="inputCelula">Selecione a célula em que irá atuar:</label>
                    <select class="custom-select d-block" name="txt_celula" id="txt_celula">
                        <option disabled selected></option>
                        <option>Canais Criticos - Abastece</option>
                        <option>Canais Criticos - Drive Thru</option>
                        <option>Canais Criticos - Estacione</option>
                        <option>Canais Criticos - Pedagio</option>
                        <option>Canais Criticos - Multa por Evasao</option>
                        <option>Canais Criticos - Pagamento Indevido</option>
                        <option>Canais Criticos - Tag Trocado</option>                      
                        <option>Canais Criticos - Vale Pedagio</option>
                        <option>Estacione</option>
                        <option>Abastece</option>
                        <option>Drive Thru</option>
                        <option>Multa por Evasao</option>
                        <option>Pagamento Indevido</option>
                        <option>Taxas B2B</option>
                        <option>Taxas FCR</option>
                        <option>Transacoes Worklist</option>
                        <option>Priorizacao</option>
                    </select>
                    <div class="invalid-feedback">
                        Por favor selecione a célula em que irá atuar.
                    </div>
                </div>
                <div>
                    <br/>
                    <button class="btn-lg btn-info" type="submit" name="btn_assign" onclick="validarStatus()">Atribuir Tarefas</button>  
                </div>
                <br/>
                <div>
                    <button type="button" class="btn btn-outline-dark"  onclick="openFormFinanceiro()" >Demanda Pagamento Indevido</button>

                    <div class="row ex2" id="controle_financeiro">
                        <br/>    
                        SELECIONE A DEMANDA:<br/><br/>

                        <div class="container">
                            <input type="radio" value="COBRANCA INDEVIDA" name="txt_natureza"/> COBRANCA INDEVIDA <br/>                    
                            <input type="radio" value="CONFIRMACAO DE DADOS BANCARIOS" name="txt_natureza"/> CONFIRMAÇÃO DE DADOS BANCÁRIOS <br/>  
                            <input type="radio" value="CREDITO A LIQUIDAR" name="txt_natureza"/> CREDITO A LIQUIDAR <br/>                         
                            <input type="radio" value="DADOS PARA REEMBOLSO" name="txt_natureza"/> DADOS PARA REEMBOLSO <br/>  
                            <input type="radio" value="DEBITO CC - NAO CLIENTE" name="txt_natureza"/> DÉBITO C/C - NÃO CLIENTE <br/>                        
                            <input type="radio" value="EFETUAR REEMBOLSO ORDEM DE PAGAMENTO" name="txt_natureza"/> EFETUAR REEMBOLSO ORDEM DE PAGAMENTO <br/>  
                            <input type="radio" value="ENVIAR COMPROVANTE REEMBOLSO" name="txt_natureza"/> ENVIAR COMPROVANTE REEMBOLSO <br/>                        
                            <input type="radio" value="REEMBOLSO PGTO. A MAIOR" name="txt_natureza"/> REEMBOLSO PGTO. A MAIOR <br/>  
                            <input type="radio" value="REEMBOLSO PGTO. DUPLICIDADE" name="txt_natureza"/> REEMBOLSO PGTO. DUPLICIDADE <br/>                        
                            <input type="radio" value="REEMBOLSO PGTO. INDEVIDO" name="txt_natureza"/> REEMBOLSO PGTO. INDEVIDO <br/>  
                            <input type="radio" value="REEMBOLSO SALDO DE CARTAO" name="txt_natureza"/> REEMBOLSO SALDO DE CARTÃO <br/>                        
                            <input type="radio" value="REEMBOLSO SEDEX - INDENIZACAO" name="txt_natureza"/> REEMBOLSO SEDEX / INDENIZAÇÃO <br/>  
                            <input type="radio" value="REVERSAO PROCESSO DE CREDITO" name="txt_natureza"/> REVERSÃO PROCESSO DE CRÉDITO <br/>
                            <button type="button" onclick="closeFormFinanceiro()">Fechar</button>
                            <br/>        
                        </div>
