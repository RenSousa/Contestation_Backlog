    ...
    <body>    
        ...
        <form action="ControllerContestation" method="post">
            ...
            <main role="main" class="container">
                <div class="jumbotron">
                    <h4 class="font-weight-light">Contestações enviadas! </h4>
                    <h3 class="text-center">Obrigado!</h3>
                    <p class="text-center">
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 58 58" style="enable-background:new 0 0 58 58;" xml:space="preserve" width="100">
                ...
                <div>
                    <br/>
                    <button class="btn-lg btn-info" type="submit" name="btn_logout">Voltar</button>  
                </div>
