...
<html>
    <head>
        ...
        <script>
            ...
            function validarStatus() {
                ...
                if (document.getElementById("list_resultado").value === "Aguardando Comprovante") {
                    document.getElementById("data_envio").setAttribute("required", "");
                    return false;
                }
            }
    ...
    <body>
            ...
            <%
                ...
                ArrayList<Contestacao> list_contestacao = (ArrayList<Contestacao>) request.getAttribute("list_contestacao");
            %>
            ...
            <main role="main">
                ...
                <% for (int counter = 0; counter < list_contestacao.size(); counter++) {
                        Contestacao contestacao = list_contestacao.get(counter);
                        if (counter == 0) {
                %>		      
                ...
                <section class="jumbotron text-center">
                    <div class="mx-auto border rounded" style="width: 1200px;">
                        ...
                        <h1 class="jumbotron-heading">
                            ...
                            Nº:<fmt:formatNumber value ="<%=contestacao.getNum_ocorrencia()%>" 
                                              type = "number" pattern="#############"/></h1>
                            <input type="hidden" name="txt_ocorrencia" value = "<fmt:formatNumber value = "<%=contestacao.getNum_ocorrencia()%>" 
                                                      type = "number" pattern="#############"/>"/>
                            <%
                                SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
                            %>
                            
                        Data de Abertura: <%=dateFormat.format(contestacao.getData_abertura())%>
                        
                        <p class="lead text-muted border">Descrição: <%=contestacao.getDescricao()%></p>
                        <div class="form-row">
                            <div class="col">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-3">
                                <%=contestacao.getNome_cliente()%>
                            </div>
                            <div class="col">
                                <%=contestacao.getTipo_pessoa()%>
                            </div>
                            <div class="col-3">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-3">
                                <%=contestacao.getNatureza()%>
                            </div>
                            <div class="col">
                                <%=contestacao.getLogin_abertura()%>
                            </div>
                            <div class="col">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col"><textarea name="txt_msg" rows=6 cols=100 value="<%=contestacao.getMsg()%>">
                                <% if (contestacao.getMsg() != null) { %>
                                    <%=contestacao.getMsg()%>
                                <% } %> 
                                </textarea>   
                            </div>
                        ...
                        <div class="row ex1" id="controle_email">
                            ...
                            <input type="date" name="txt_dataenvio" value="<%=contestacao.getEmail().getData_envio()%>">
                            <% } else { %>
                            <input type="date" id="data_envio" name="txt_dataenvio" value="">
                            <% } %>
                            Data Recebimento:
                            <% if (contestacao.getEmail().getData_recebimento() != null) { %>
                            <input type="date" id="data_receb" name="txt_datareceb" value="<%=contestacao.getEmail().getData_recebimento()%>">
                            <% } else { %>
                            <input type="date" id="data_receb" name="txt_datareceb" value="">
                            <% } %>
                        ...
                        <p>
                            <button type="submit" name="btn_procedente" class="btn btn-primary my-2">
                            ...
                            <button type="submit" name="btn_improcedente" class="btn btn-primary my-2" onclick="validarStatusImp()">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            ...
                            <button type="submit" name="btn_enviar" class="btn btn-primary my-2" onclick="validarStatus()">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <p class="text-center">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                     viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" width="20">
                                <path style="fill:#66C6B9;" d="M420.773,61.867H92.24c-18.133,0-32,13.867-32,32V480c0,18.133,13.867,32,32,32h327.467
                                      c18.133,0,32-13.867,32-32V93.867C452.773,75.733,437.84,61.867,420.773,61.867z"/>
                                <rect x="101.84" y="103.467" style="fill:#FFFFFF;" width="309.333" height="366.933"/>
                                <g>
                                <rect x="140.24" y="155.733" style="fill:#E8EAE9;" width="231.467" height="22.4"/>
                                <rect x="140.24" y="214.4" style="fill:#E8EAE9;" width="231.467" height="22.4"/>
                                </g>
                                <path style="fill:#415A6B;" d="M349.306,122.667v-60.8c0-12.8-9.6-22.4-22.4-22.4h-30.933C295.973,18.133,278.906,0,256.506,0
                                      c-21.333,0-39.467,18.133-39.467,39.467h-30.933c-12.8,0-22.4,9.6-22.4,22.4v60.8H349.306z M256.506,27.733
                                      c6.4,0,12.8,5.333,12.8,12.8c0,6.4-5.333,12.8-12.8,12.8c-7.467,0-12.8-5.333-12.8-12.8S250.106,27.733,256.506,27.733z"/>
                                <path style="fill:#E8EAE9;" d="M318.373,426.667H194.64c-5.333,0-10.667-4.267-10.667-10.667V292.267
                                      c0-5.333,4.267-10.667,10.667-10.667h123.733c5.333,0,10.667,4.267,10.667,10.667V416
                                      C329.04,421.333,324.773,426.667,318.373,426.667z M204.24,405.333h103.467V301.867H204.24L204.24,405.333L204.24,405.333z"/>
                                <path style="fill:#F3705A;" d="M348.24,281.6c-5.333-5.333-12.8-5.333-18.133,0l-82.133,82.133L210.64,326.4
                                      c-5.333-5.333-12.8-5.333-18.133,0c-5.333,5.333-5.333,12.8,0,18.133l46.933,46.933c5.333,5.333,12.8,5.333,18.133,0l91.733-91.733
                                      C353.573,294.4,353.573,286.933,348.24,281.6z"/>

                                </svg>
                                Nº:<fmt:formatNumber value ="<%=contestacao.getNum_ocorrencia()%>" 
                                                  type = "number" pattern="#############"/> </p>
                            <div class="card-body">
                                <p class="small"><%=contestacao.getTipo()%>/<%=contestacao.getNatureza()%></p>
                                <p class="card-text text-muted">Descrição: <%=contestacao.getDescricao()%></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary">Ver</button>
                                    </div>
                                    <small class="text-muted"><%=contestacao.getData_abertura()%></small>
                                    <small class="text-muted"><%=contestacao.getNrc()%></small>
                                </div>
                            </div>
                        </div>
                    </div>
